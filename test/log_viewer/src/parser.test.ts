...
import { escAttr, escHtml, parseLog } from "./parser";
...
describe("parseLog", () => {
    ...
    it("arg obj#17 refs get data-uid matching the new id uid", () => {
        const log =
            "[ 100.000] {Default Queue}  -> zwp_pointer_gestures_v1#10.get_hold_gesture(new id zwp_pointer_gesture_hold_v1#17, wl_pointer#35)";
        const { lines } = parseLog(log);
