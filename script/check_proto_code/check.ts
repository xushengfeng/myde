...
const protoCode = fs.readFileSync(path.join(__dirname, "../../src/wayland/server.ts"), "utf8");

const WaylandProtocolsx = JSON.parse(
    fs.readFileSync(path.join(__dirname, "../../src/wayland/protocols/protocols.json"), "utf8"),
